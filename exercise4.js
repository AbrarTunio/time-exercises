...
fillFour2 = document.querySelector("#fillFour2");
statFou = document.querySelector("#statFou");

function questionFou() {
  if (
    fillFou.value == "<source" &&
    fillFour.value == ">" &&
    fillFour1.value == "<source" &&
    fillFour2.value == ">"
  ) {
...
fillFive1 = document.querySelector("#fillFive1");
...
function questionSix() {
  if (fillSix.value == "autoplay" && fillSix1.value == "</video>") {
